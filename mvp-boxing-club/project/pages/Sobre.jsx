...
function SobrePage() {
  ...
  return (
    <section data-screen-label="Sobre" className="relative pt-32 pb-24 sm:pt-40 sm:pb-32 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
          {features.map((f, i) => {
            ...
            return (
              <div key={f.title} className="group relative p-7 bg-cream border border-stone-200 hover:border-transparent transition-all duration-500 animate-reveal-up" style={{ animationDelay: `${i * 100 + 100}ms` }}>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {['Iniciantes', 'Avançados', 'Mulheres', 'Jovens', 'Adultos', 'Quem quer perder peso', 'Quem quer competir', 'Saúde mental'].map((tag, i) => (
            <span key={tag} className={`px-4 py-1.5 border text-xs uppercase tracking-wider transition-colors cursor-default ${
