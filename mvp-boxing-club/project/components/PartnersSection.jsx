// ============================================================
// Partner badges — Wellhub & TotalPass (we accept these)
// ============================================================
function PartnersSection({ compact }) {
  return (
...
// Stylized brand marks (premium, not exact replicas)
function WellhubMark({ className }) {
  return (
...
function TotalPassMark({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 6h8"/>
      <path d="M8 6v12"/>
...
Object.assign(window, { PartnersSection });
